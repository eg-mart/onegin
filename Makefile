...
OBJS_NAMES = file_reading.o sort.o
OBJDIR = build
OBJS = $(addprefix $(OBJDIR)/, $(OBJS_NAMES))

onegin : $(OBJS) $(OBJDIR)/main.o
	$(CC) $(CFLAGS) -o onegin $(OBJS) $(OBJDIR)/main.o

$(OBJDIR)/main.o : main.cpp sort.h file_reading.h
	$(CC) $(CFLAGS) -c $< -o $@
